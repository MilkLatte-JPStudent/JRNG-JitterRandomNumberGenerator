...
[JRNG 17万サンプル検証グラフデータ数値](benchmark/-1000~1000.loopJRNG.log.438000data.csv)
![JRNG 43.8万サンプル検証グラフ画像](benchmark/-1000~1000.loopJRNG.log.1351610data_values_chart.png)
[JRNG 17万サンプル検証グラフデータ数値](benchmark/-1000~1000.loopJRNG.log.1351610data.csv)
